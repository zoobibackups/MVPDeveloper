  ...
  return (
    ...
    >
      <CustomHeader
        ...
        subTitle={"WORKOUTS YOU WOULD LIKE\nTO AVOID"}
      />
      ...
      <View style={styles.innerContainer}>
        <TouchableOpacity onPress={() => setChecked(!checked)}>
          ...
          >
            <Text style={styles.selectItemText}>Calisthenics</Text>
            <Checkbox              
              isChecked={checked}
              onPress={() => {
                setChecked(!checked);
        ...
        <TouchableOpacity onPress={() => setChecked1(!checked1)}>
          ...
          >
            <Text style={styles.selectItemText}>Swimming</Text>
            <Checkbox
              isChecked={checked1}
              onPress={() => {
