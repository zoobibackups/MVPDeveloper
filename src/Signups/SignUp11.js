  ...
  return (
    ...
    >
      <CustomHeader
        ...
        subTitle={"TELL US ABOUT YOUR BUDGET"}
      />
      ...
      <View style={styles.innerContainer}>
        <TouchableOpacity onPress={() => setChecked(!checked)}>
          ...
          >
            <Text style={styles.selectItemText}>Low budget</Text>
            <Checkbox
              isChecked={checked}
              onPress={() => {
                setChecked(!checked);
        ...
        <TouchableOpacity onPress={() => setChecked1(!checked1)}>
          <LinearGradient
            ...
            style={styles.selectItem}
          >
            <Text style={styles.selectItemText}>Medium budget</Text>
            <Checkbox
              isChecked={checked1}
              onPress={() => {
        ...
        <TouchableOpacity onPress={() => setChecked2(!checked2)}>
          <LinearGradient
            ...
            style={styles.selectItem}
          >
            <Text style={styles.selectItemText}>Luxury budget</Text>
            <Checkbox
              isChecked={checked2}
              onPress={() => {
        ...
        <TouchableOpacity onPress={() => setChecked3(!checked3)}>
          <LinearGradient
            ...
            style={styles.selectItem}
          >
            <Text style={styles.selectItemText}>No budget</Text>
            <Checkbox
              isChecked={checked3}
              onPress={() => {
